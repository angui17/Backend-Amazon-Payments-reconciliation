/**
 * ID 263: Sales Fees (CTS_AMAZON_SALES_FEES_RECONCILIATIONS)
 * Stored Procedure: CTS_AMAZON_SALES_FEES_RECONCILIATIONS
 */
import { getDefaultDates, getStr, getInt } from '../utils/helpers.js';

export const procedureName = 'CTS_AMAZON_SALES_FEES_RECONCILIATIONS';
...
export function buildParams(params) {
  ...
  if (!types) {
    throw new Error('Parameter "types" (CSV) is required. Example: { "types": "ADJUSTMENT,AMAZON FEES", "last": 10 }');
  }
