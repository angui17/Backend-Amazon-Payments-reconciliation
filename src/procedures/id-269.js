/**
 * ID 269: Accounting Journal Header (CTS_ACCOUNTING_JOURNAL_HEADER)
 * Stored Procedure: CTS_ACCOUNTING_JOURNAL_HEADER
 */
import { getDefaultDates, getStr, getInt } from '../utils/helpers.js';

export const procedureName = 'CTS_ACCOUNTING_JOURNAL_HEADER';
...
export function buildParams(params) {
  ...
  const limitRecords = getInt(limit_records) || 100;
